...
def readInput():
    with open('input.txt', 'r') as f:
        instructions = [{"instruction": x[0], "value": int(x[1:])}
...
def part1(instructions):
    ...
    for instruction in instructions:
        if instruction.get("instruction") == "N":
            y += instruction.get("value")
        elif instruction.get("instruction") == "E":
            x += instruction.get("value")
        elif instruction.get("instruction") == "S":
            y -= instruction.get("value")
        elif instruction.get("instruction") == "W":
            x -= instruction.get("value")
        elif instruction.get("instruction") == "F":
            if direction == 0:
                x += instruction.get("value")
            elif direction == 90:
                y += instruction.get("value")
                ...
                y -= instruction.get("value")
        elif instruction.get("instruction") == "L":
            direction += instruction.get("value")
            direction %= 360
        elif instruction.get("instruction") == "R":
            direction -= instruction.get("value")
            direction %= 360
    distance = abs(x) + abs(y)
    print("Part 1: Manhattan distance = {}".format(distance))
...
def part2(instructions):
    ...
    for instruction in instructions:
        if instruction.get("instruction") == "N":
            waypoint_y += instruction.get("value")
        elif instruction.get("instruction") == "E":
            waypoint_x += instruction.get("value")
        elif instruction.get("instruction") == "S":
            waypoint_y -= instruction.get("value")
        elif instruction.get("instruction") == "W":
            waypoint_x -= instruction.get("value")
        elif instruction.get("instruction") == "F":
            ship_x += (waypoint_x * instruction.get("value"))
            ship_y += (waypoint_y * instruction.get("value"))
        elif instruction.get("instruction") == "L":
            direction = instruction.get("value") % 360
            if direction == 90:
    ...
    print("Part 2: Manhattan distance = {}".format(distance))
